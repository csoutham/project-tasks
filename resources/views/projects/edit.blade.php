<x-app-layout>
	<x-slot name="header">
		<h2 class="text-2xl text-gray-800 title">{{ $project->name }}</h2>
    </x-slot>
    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 py-12">
        ...
        <div class="px-4 py-4 bg-white overflow-hidden shadow-sm sm:rounded-md">
            <form action="{{ action('\App\Http\Controllers\ProjectsController@update', $project) }}" method="post">
                @csrf
                @method('PUT')
